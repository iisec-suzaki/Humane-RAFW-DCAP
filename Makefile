...
Client_Cpp_Files := Client_App/client_app.cpp common/base64.cpp common/debug_print.cpp common/hexutil.cpp \
				common/crypto.cpp common/error_print.cpp
...
## リンクオプション
Client_Link_Flags := $(SGX_COMMON_CFLAGS) -lsgx_dcap_quoteverify -lpthread -lcrypto -lssl
...
## コンパイル時に使用するC/C++のソースを列挙
App_Cpp_Files := Server_App/server_app.cpp common/error_print.cpp common/base64.cpp \
...
App_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) \
					...
					-lsgx_dcap_ql -ldcap_quoteprov -lsgx_tcrypto \
